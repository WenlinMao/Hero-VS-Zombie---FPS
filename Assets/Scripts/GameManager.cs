...
public class GameManager : MonoBehaviour {
	...
	void Update () {
		...
		case GameState.Playing:		
			...
			//否则，当前游戏状态还是游戏进行时状态
				...
				timeText.text = "Battle Time： " + currentTime.ToString ("0.00");	//显示已用时间
	...
	void EditGameOverCanvas(){
		...
		case "1":
			gameMessage.text = "Congratulation！You got the first place.";
			break;
		case "2":
			gameMessage.text = "Congratulation！You got the second place.";
			break;
		case "3":
			gameMessage.text = "Congratulation！You got the third place.";
			break;
		default:
			gameMessage.text = "";
			break;
